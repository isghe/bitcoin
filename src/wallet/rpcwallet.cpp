...
{ //  category              name                                actor (function)                argNames
    ...
    { RPCCategory::WALLET,             "walletcreatefundedpsbt",           &walletcreatefundedpsbt,        {"inputs","outputs","locktime","replaceable","options","bip32derivs"} },
    ...
    { RPCCategory::WALLET,             "addmultisigaddress",               &addmultisigaddress,            {"nrequired","keys","label|account","address_type"} },
    ...
    { RPCCategory::WALLET,             "getbalance",                       &getbalance,                    {"account|dummy","minconf","include_watchonly"} },
    { RPCCategory::WALLET,             "getnewaddress",                    &getnewaddress,                 {"label|account","address_type"} },
    ...
    { RPCCategory::WALLET,             "listtransactions",                 &listtransactions,              {"account|dummy","count","skip","include_watchonly"} },
    ...
    { RPCCategory::WALLET,             "sendmany",                         &sendmany,                      {"fromaccount|dummy","amounts","minconf","comment","subtractfeefrom","replaceable","conf_target","estimate_mode"} },
    ...
    { RPCCategory::WALLET,             "getaccountaddress",                &getaccountaddress,             {"account"} },
    { RPCCategory::WALLET,             "getaccount",                       &getaccount,                    {"address"} },
    { RPCCategory::WALLET,             "getaddressesbyaccount",            &getaddressesbyaccount,         {"account"} },
    { RPCCategory::WALLET,             "getreceivedbyaccount",             &getreceivedbylabel,            {"account","minconf"} },
    { RPCCategory::WALLET,             "listaccounts",                     &listaccounts,                  {"minconf","include_watchonly"} },
    { RPCCategory::WALLET,             "listreceivedbyaccount",            &listreceivedbylabel,           {"minconf","include_empty","include_watchonly"} },
    { RPCCategory::WALLET,             "setaccount",                       &setlabel,                      {"address","account"} },
    { RPCCategory::WALLET,             "sendfrom",                         &sendfrom,                      {"fromaccount","toaddress","amount","minconf","comment","comment_to"} },
    { RPCCategory::WALLET,             "move",                             &movecmd,                       {"fromaccount","toaccount","amount","minconf","comment"} },
